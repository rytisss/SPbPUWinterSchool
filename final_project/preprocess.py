...
def insertROI2BlackImage(imageROI, destination_width, destination_height):
    ...
    center_x = int(destination_width / 2)
    center_y = int(destination_height / 2)
...
def preprocess():
    ...
    output_dir = r'C:\Users\Rytis\Desktop\SPbPUWinterSchool\final_project\prepared_data/'
    ...
    for subdir in subdirs:
        ...
        for image_path in image_paths:
            ...
            # resize to center
            processed_image = insertROI2BlackImage(image, desired_size[0], desired_size[1])
            cv2.imwrite(class_output_dir + image_name + '.jpg', processed_image)
